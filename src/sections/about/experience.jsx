  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-[1600px] px-6 lg:px-10">
        {/* Eyebrow + heading, left-aligned top-down. */}
        <header className="max-w-[1180px]">
          <div className="flex items-center gap-3 text-[0.82rem] uppercase tracking-[0.28em] text-foreground/60">
            ...
            <span
              ...
              aria-hidden="true"
            />
            <span>{ABOUT.experience.eyebrow}</span>
          </div>

          <h2
            ref={headingRef}
            className="mt-8 text-balance text-[clamp(2.75rem,6.5vw,6rem)] leading-[0.92] tracking-[0.005em]"
          >
            <SplitText mode="words">{ABOUT.experience.heading}</SplitText>
          </h2>
        </header>

        <div className="relative mt-12 max-w-4xl bg-background p-8 lg:p-12">
